...
phần tư) tổng số điểm của Nội dung 2</td>
        <td>
          <div class="checkbox">
...
động tình nguyện….(+2đ/lần)
    ...
    an toàn giao thông, (-5đ/lần)</td>
      ...
      <tr>
        <td>- Không có tinh thần giúp đỡ bạn bè, không thể hiện tinh thần đoàn kết tập thể
(-5đ/lần)</td>
...
<div class="form-group"> 
            ...
            <hr>
            <h3><i>Nhận xét của lớp trưởng</i></h3>  
            ...
            <hr>
            <h3><i>Nhận xét của lớp cố vấn</i></h3>  
            <textarea name="adv_cmt" id="editor_adv" class="required" >
                <?=$data_pre->efst_comment_2;?>


            </textarea>
            <?php if($data_pre->efst_status >2){ ?>

              <div class="checkbox text-center">
                <label><input type="checkbox" name="adv_accept"
                <?php 
                    if ($data_pre->efst_status == 4) {
                        echo "checked disabled";
                    }
                ?> 
                value="4">Gửi lên khoa</label><br>
