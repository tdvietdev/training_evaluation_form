...
class Semester extends Admin_Controller {
	...
	{
		$crud = $this->generate_crud('evaluation_form');
		// var_dump($crud);
		$crud->columns('ef_id', 'ef_name', 'ef_description','ef_available');
		...
		// 	$crud->set_relation_n_n('classes', 'user_class', 'classes', 'user_id', 'class_id', 'class_name');
		// }
